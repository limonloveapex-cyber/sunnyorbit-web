...
const pages = {
  ...
  'features': {
    ...
    desc: 'Expense and income tracking, shared spaces with a balance per member, budgets, loans, receipt photos, CSV and PDF export, app lock and four home-screen widgets.',
  },
  'faq': {
    out: 'faq.html',
    nav: 'faq',
    title: 'FAQ & Support — Pooled',
    desc: 'Answers about tracking money, shared spaces, budgets, loans, exports and privacy in Pooled — plus how to reach the team that builds it.',
  },
  'privacy': {
    out: 'privacy.html',
    nav: null,
    title: 'Privacy Policy — Pooled',
    desc: 'What Pooled stores on your phone, what it holds if you make an account, the one request it makes to a third party, and how to get rid of all of it.',
  },
  'terms': {
    out: 'terms.html',
    nav: null,
    title: 'Terms of Service — Pooled',
    desc: 'The terms covering the Pooled Android app and this website, operated by SunnyOrbit.',
  },
  'delete-account': {
